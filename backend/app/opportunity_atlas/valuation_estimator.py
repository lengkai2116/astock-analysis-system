...
# 477号：东财行业（Tushare stock_basic.industry 实际口径）→ 七大分类。
# Stock.industry 存的是东财二级行业名（白酒/全国地产/电气设备…），与上方申万键
# 两套体系错位 → 97.6% 股票落「微小/亏损」兜底权重（核查实证 2026-09-23）。
# _category 优先查本表，其次查 INDUSTRY_CATEGORY（申万），最后兜底微小/亏损。
EASTMONEY_CATEGORY: dict[str, str] = {
    # 蓝筹（消费+品牌制造）
    '食品': '蓝筹', '家用电器': '蓝筹', '家居用品': '蓝筹', '服饰': '蓝筹',
    '白酒': '蓝筹', '日用化工': '蓝筹', '乳制品': '蓝筹', '软饮料': '蓝筹',
    '啤酒': '蓝筹', '红黄酒': '蓝筹', '汽车整车': '蓝筹', '汽车服务': '蓝筹',
    '摩托车': '蓝筹', '酒店餐饮': '蓝筹', '百货': '蓝筹', '超市连锁': '蓝筹',
    '旅游景点': '蓝筹', '旅游服务': '蓝筹', '文教休闲': '蓝筹', '造纸': '蓝筹',
    '玻璃': '蓝筹', '陶瓷': '蓝筹', '其他建材': '蓝筹', '纺织': '蓝筹',
    # 成长（医药/农业/传媒/新能源设备）
    '电气设备': '成长', '汽车配件': '成长', '医疗保健': '成长', '化学制药': '成长',
    '生物制药': '成长', '中成药': '成长', '医药商业': '成长', '农业综合': '成长',
    '种植业': '成长', '渔业': '成长', '饲料': '成长', '林业': '成长',
    '影视音像': '成长', '出版业': '成长', '广告包装': '成长', '互联网': '成长',
    # 周期（资源/地产/基建/机械/交运）
    '化工原料': '周期', '塑料': '周期', '农药化肥': '周期', '染料涂料': '周期',
    '化纤': '周期', '橡胶': '周期', '小金属': '周期', '铝': '周期', '铜': '周期',
    '铅锌': '周期', '黄金': '周期', '普钢': '周期', '特种钢': '周期', '钢加工': '周期',
    '煤炭开采': '周期', '焦炭加工': '周期', '石油开采': '周期', '石油加工': '周期',
    '石油贸易': '周期', '水泥': '周期', '矿物制品': '周期', '区域地产': '周期',
    '全国地产': '周期', '园区开发': '周期', '房产服务': '周期', '装修装饰': '周期',
    '建筑工程': '周期', '工程机械': '周期', '机械基件': '周期', '机床制造': '周期',
    '轻工机械': '周期', '纺织机械': '周期', '化工机械': '周期', '农用机械': '周期',
    '专用机械': '周期', '运输设备': '周期', '船舶': '周期', '航空': '周期',
    '空运': '周期', '水运': '周期', '铁路': '周期', '公路': '周期', '路桥': '周期',
    '港口': '周期', '机场': '周期', '公共交通': '周期', '仓储物流': '周期',
    '综合类': '周期', '商品城': '周期', '批发业': '周期', '商贸代理': '周期',
    '其他商业': '周期', '电器连锁': '周期', '环境保护': '周期',
    # 科技（高研发）
    '半导体': '科技', '元器件': '科技', '软件服务': '科技', 'IT设备': '科技',
    '通信设备': '科技', '电器仪表': '科技', '电信运营': '科技',
    # 金融
    '银行': '金融', '证券': '金融', '保险': '金融', '多元金融': '金融',
    # 稳定收息（公用事业）
    '新型电力': '稳定收息', '火力发电': '稳定收息', '水力发电': '稳定收息',
    '水务': '稳定收息', '供气供热': '稳定收息',
}
