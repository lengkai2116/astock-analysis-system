...
_WORKDAY_WEEKENDS = frozenset({
    '2026-01-04',   # 元旦调休（1/4 周日上班）
    '2026-02-14',   # 春节调休（2/14 周六上班）
    '2026-02-28',   # 春节调休（2/28 周六上班）
    '2026-05-09',   # 劳动节调休（5/9 周六上班）
    '2026-09-20',   # 国庆调休（9/20 周日上班）
    '2026-10-10',   # 国庆调休（10/10 周六上班）
})
