...
背景：_DEFAULT_HOLIDAYS 曾混入错误日期（2026-09-15/16/17 实为 2025 中秋错位，
春节 01-28~02-03 为 2025 春节、端午 06-12~14 错位、国庆多 10-08），且调休上班的
周末（1/4、2/14、2/28、5/9、9/20、10/10）被周末规则误判为节假日。
依据《国务院办公厅关于2026年部分节假日安排的通知》修正：
...
class TestWorkdayWeekends:
    ...
    def test_adjusted_workday_weekends_not_holiday(self):
        for s in ('2026-01-04', '2026-02-14', '2026-02-28',
            ...
            assert is_holiday(_d(s)) is False, f'{s} 为调休上班日，不应是节假日'
