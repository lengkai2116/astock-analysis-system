...
def fetch_real_stock_data(ts_code, db_path):
    """从DuckDB获取真实股票数据"""
...
def plot_chanlun(ts_code, klines_raw, klines_merged, fractals, strokes, segments, pivot, output_file):
    ...
    ax1.set_title(f'CHANLUN Complete Structure - {ts_code}', fontsize=18, pad=25, color='white', fontweight='bold')
...
def main():
    ...
    klines_raw = fetch_real_stock_data(ts_code, db_path)
    ...
    output_file = f'/Users/kalence/Desktop/测试/chanlun_{ts_code}.png'
